...
$hebrewDate = iconv ('WINDOWS-1255', 'UTF-8', $hebrewDate); // convert to utf-8
	...
	case preg_match(iconv ('WINDOWS-1255', 'UTF-8', '/י"ג תשרי/'), $hebrewDate) == 1:// סוכות
	case preg_match(iconv ('WINDOWS-1255', 'UTF-8', '/כ"א תשרי/'), $hebrewDate) == 1:// שמיני עצרת
	case preg_match(iconv ('WINDOWS-1255', 'UTF-8', '/י"ג ניסן/'), $hebrewDate) == 1:// פסח
	case preg_match(iconv ('WINDOWS-1255', 'UTF-8', '/י"ט ניסן/'), $hebrewDate) == 1:// שביעי של פסח
